...
Visual families may recolor the rail to match their surface (for example the Guide document theme or Worlds/Nexus immersive chrome), but the DOM order, labels, interaction model and responsive behavior remain shared. Worlds/Nexus may preserve their fixed rail height because their immersive viewport math depends on it.
