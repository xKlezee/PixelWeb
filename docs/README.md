...
- `scripts/validate_social_metadata.py` — sitemap-indexed Open Graph/Twitter consistency guard, including canonical social URLs, document titles and the official shared logo; intentionally `noindex` Forum/404 pages are outside this indexed-page contract;
