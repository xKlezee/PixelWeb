...
- `validate_public_bundle.py` verifies that `_site/` contains only declared public HTML, referenced/approved root resources and expected static asset/data formats. It re-validates local HTML/deferred-media and CSS dependencies, and rejects internal repository paths, environment files, key/certificate material, logs/databases, root-relative project-site URLs and missing local references.
